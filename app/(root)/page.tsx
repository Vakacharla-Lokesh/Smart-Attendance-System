    ...
    <div className="flex min-h-screen bg-gradient-to-b from-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="flex-1 p-8 grid grid-rows-[auto,1fr,auto] gap-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-2">
              👋 Welcome, <span className="text-rose-400">Dr. S.K. Chaudhry</span>
            </h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          <ActionCard icon={<ClipboardList />} title="Mark Attendance" />
          <ActionCard icon={<Users />} title="View Students" />
          <ActionCard icon={<BarChart3 />} title="Reports / Analytics" />
        </div>
        ...
        <div className="mt-6 bg-gray-800/40 backdrop-blur-lg p-6 rounded-2xl shadow-lg border border-gray-700">
          ...
          <div className="space-y-3 text-gray-300">
            <ScheduleItem time="09:30 AM" subject="IoT 401" room="Room 205" />
            <ScheduleItem
              time="11:00 AM"
